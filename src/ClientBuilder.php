...
use Elastic\Elasticsearch\Serverless\ClientInterface as ServerlessClientInterface;
...
use Elastic\Elasticsearch\Serverless\Transport\RequestOptions;
use Elastic\Elasticsearch\Serverless\Transport\Adapter\AdapterInterface;
use Elastic\Elasticsearch\Serverless\Transport\Adapter\AdapterOptions;
...
class ClientBuilder
{
    ...
    public function build(): ServerlessClientInterface
    {
         ...
         * @see https://github.com/elastic/elasticsearch-serverless-php/issues/1241 omit for Symfony HTTP Client    
         */
